...
row_num = 100000
test_num= 2500
dos_data = pd.read_csv("C:\CAN_dataset\data\DoS_dataset.csv",header=None)
...
display(img)
#for fuzzy dataset
fuzzy_data = pd.read_csv("C:\CAN_dataset\data\Fuzzy_dataset.csv",sep=',',header=None)
...
#for gear dataset
gear_data = pd.read_csv("C:\CAN_dataset\data\gear_dataset.csv",sep=',',header=None)
...
#for rpm dataset
rpm_data = pd.read_csv("C:\CAN_dataset\data\RPM_dataset.csv",sep=',',header=None)
...
features_train, features_test, labels_train, labels_test = train_test_split(features, transfomed_label, test_size=0.4, random_state=0)
...
metrics_callback = MetricsCallback((features_test, labels_test))

history = model.fit(features_train, labels_train, epochs=n_epoch, batch_size=32, validation_data=(features_test, labels_test), callbacks=[metrics_callback])

current_directory = os.getcwd()
model.save(os.path.join(current_directory, "singlestepfull.h5"))
test_loss, test_accuracy, precision, recall, = model.evaluate(features_test, labels_test)

print("Test Loss:", test_loss)
print("Test Accuracy:", test_accuracy)

precision_values = metrics_callback.precision_values
recall_values = metrics_callback.recall_values
f1_values = metrics_callback.f1_values
...
#plt.show()
plt.savefig("C:/ssg/plot12.png",dpi=120)
import matplotlib.pyplot as plt
...
plt.savefig("C:/ssg/losses.png",dpi=120)
...
plt.legend()
legend = ax.legend(loc='lower right', fontsize='x-small', title_fontsize=15)
plt.savefig("C:/ssg/accuracy.png",dpi=120)
...
plt.legend()
legend = ax.legend(loc='lower right', fontsize='x-small', title_fontsize=15)
plt.savefig("C:/ssg/Precision.png",dpi=120)
#Recall Plot
epochs = range(1, n_epoch+1)
...
plt.legend()
legend = ax.legend(loc='lower right', fontsize='x-small', title_fontsize=15)
plt.savefig("C:/ssg/Recall.png",dpi=120)
...
plt.ylabel('F1 Score')
plt.legend()
plt.savefig("C:/ssg/f1score.png", dpi=120)
