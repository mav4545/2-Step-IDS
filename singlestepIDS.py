# -*- coding: utf-8 -*-
"""
Created on Sat May 27 01:06:43 2023
...
history = model.fit(features_train, labels_train, epochs=n_epoch, batch_size=32, validation_data=(features_test, labels_test))
